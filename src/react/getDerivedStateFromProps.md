...
The parent form component could then  [use a  `ref`  to call this method](https://reactjs.org/docs/glossary.html#refs). ([Click here to see a demo of this pattern.](https://codesandbox.io/s/l70krvpykl))
